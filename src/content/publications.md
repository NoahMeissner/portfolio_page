...
publications:
  - year: "2026"
    title: "Seeing Around the Corner: Fusing Visual Flow and Inertial Sensors."
    venue: "GeoAI 2026. (In Review)"
    authors: "Meißner, N. & Ludwig, B."
    details:
      - "Proposed a sensor fusion algorithm outperforming standard PDR by 60% (94.2% accuracy)."
      - "Engineered a HoloLens 2 SLAM rig for sub-cm Ground Truth generation, validated via loop-closure analysis (0.13% error)."
  - year: "2025"
    title: "Beyond Labels: A Circumplex-Based Framework for Emotion on X."
